...
public interface UserPostStatisticInfo {
    ...
    Call<PostInfoWrapper> getUserPostInfoBySlug(@Query("slug") String mSlug);
    ...
    @POST("users/posts/get")
    Call<PostInfoWrapper> getUserPostInfoById(@Query("id") Integer id);
    ...
    Call<PostUsersList> getUserPostLikersInfoById(@Query("id") Integer id);
    ...
    Call<PostUsersList> getUserPostCommentatorsById(@Query("id") Integer id);
    ...
    Call<PostUsersList> getUserPostRepostersById(@Query("id") Integer id);
    ...
    Call<PostUsersList> getMentionedUsersById(@Query("id") Integer id);
}
